...
simonato = sprites.create(assets.image`simonato`, SpriteKind.Player)
...
game.onUpdateInterval(randint(500, 1000), function () {
    benedetta = sprites.create(assets.image`ben`, SpriteKind.Enemy)
    benedetta.setPosition(0, randint(20, 120))
